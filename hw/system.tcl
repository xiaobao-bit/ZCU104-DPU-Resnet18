file mkdir zcu104_dpu_pfm
create_project zcu104_dpu prj -part xczu7ev-ffvc1156-2-e -force
...
set dpu_ip_repo "[file normalize ./dpu_ip/DPUCZDX8G_v4_1_0]"
if {[file exists $dpu_ip_repo]} {
    set_property ip_repo_paths $dpu_ip_repo [current_project]
    update_ip_catalog
} else {
    puts "DPU IP repo not found at $dpu_ip_repo"
    return 1
}
...
proc create_root_design { parentCell } {
 ...
 ] [get_bd_pins /dpuczdx8g_0/m_axi_dpu_aclk]
...
\
  ...
  connect_bd_intf_net -intf_net dpuczdx8g_0_DPU0_M_AXI_INSTR [get_bd_intf_pins dpuczdx8g_0/DPU0_M_AXI_INSTR] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins clk_wiz_0/clk_dpu] [get_bd_pins dpuczdx8g_0/m_axi_dpu_aclk] [get_bd_pins rst_gen_clk/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net Net1 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins dpuczdx8g_0/s_axi_aresetn] [get_bd_pins rst_gen_clk/ext_reset_in] [get_bd_pins rst_gen_clk_dsp/ext_reset_in] [get_bd_pins rst_gen_reg/peripheral_aresetn]
  connect_bd_net -net clk_wiz_0_clk_dsp [get_bd_pins clk_wiz_0/clk_dsp] [get_bd_pins dpuczdx8g_0/dpu_2x_clk] [get_bd_pins rst_gen_clk_dsp/slowest_sync_clk]
  ...
  connect_bd_net -net dpuczdx8g_0_dpu_2x_clk_ce [get_bd_pins clk_wiz_0/clk_dsp_ce] [get_bd_pins dpuczdx8g_0/dpu_2x_clk_ce]
  connect_bd_net -net rst_gen_clk_dsp_peripheral_aresetn [get_bd_pins dpuczdx8g_0/dpu_2x_resetn] [get_bd_pins rst_gen_clk_dsp/peripheral_aresetn]
  connect_bd_net -net rst_gen_clk_peripheral_aresetn [get_bd_pins dpuczdx8g_0/m_axi_dpu_aresetn] [get_bd_pins rst_gen_clk/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins dpuczdx8g_0/s_axi_aclk] [get_bd_pins rst_gen_reg/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  set_property PFM.CLOCK {clk_dsp {id "2" is_default "false" proc_sys_reset "/rst_gen_clk_dsp" status "fixed" freq_hz "650000000"} clk_dpu {id "3" is_default "true" proc_sys_reset "/rst_gen_clk" status "fixed" freq_hz "325000000"}} [get_bd_cells /clk_wiz_0]
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"}} [get_bd_cells /smartconnect_0]
  set_property PFM.AXI_PORT {S_AXI_HPC0_FPD {memport "S_AXI_HPC" sptag "" memory "" is_range "false"} S_AXI_HPC1_FPD {memport "S_AXI_HPC" sptag "" memory "" is_range "false"}} [get_bd_cells /zynq_ultra_ps_e_0]
  set_property PFM.CLOCK {pl_clk0 {id "0" is_default "false" proc_sys_reset "/rst_gen_reg" status "fixed" freq_hz "100000000"}} [get_bd_cells /zynq_ultra_ps_e_0]
